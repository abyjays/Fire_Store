  ...
  return (
    <div className="container">
      ...
      <div className="table-responsive">
        {userOrders.length > 0 ? (
          <table>
            <thead><tr><th>Order ID</th><th>Items Ordered</th><th>Total Paid</th><th>Status</th></tr></thead>
            <tbody>
              {userOrders.map((o) => {
                ...
                return (
                  <tr key={o.id}>
                    <td>#{o.id.split('-')[0]}</td>
                    <td>{o.items.map((item, idx) => (<div key={idx}>• {item.productname} (x{item.cartQuantity})</div>))}</td>
