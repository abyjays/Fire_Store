            ...
            <tbody>
              {products.map((p, i) => (
                <tr key={i}>
                  ...
                  <td>
                    <input type="number" value={p.quantity} onChange={(e) => handleQuantityChange(i, e.target.value)} style={{ width: "80px", padding: "0.4rem" }} />
                  </td>
                  <td><button className="action-btn delete-btn" onClick={() => handleDelete(i)}>Delete</button></td>
                </tr>
              ))}
            </tbody>
          </table>
